...
const setAtualizarFilme = async function (id, dadoAtualizado, contentType) {
    if (String(contentType).toLowerCase() == 'application/json') {
        ...
        if (dadoAtualizado.nome == '' || dadoAtualizado.nome == undefined || dadoAtualizado.nome == null || dadoAtualizado.nome.length > 80 ||
            ...
            dadoAtualizado.valor_unitario == '' || dadoAtualizado.valor_unitario == undefined || dadoAtualizado.valor_unitario == null || dadoAtualizado.valor_unitario.length > 6 ||
            dadoAtualizado.data_relancamento == '' || dadoAtualizado.data_relancamento == null || dadoAtualizado.data_relancamento == undefined || dadoAtualizado.data_relancamento.length != 10) {
